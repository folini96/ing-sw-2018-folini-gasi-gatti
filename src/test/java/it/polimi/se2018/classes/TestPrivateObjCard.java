...
public class TestPrivateObjCard {
    ...
    public void testRightScore() {
        ...
        boxSchemeTest[0][4] = new Box("rosso", 0);
        boxSchemeTest[1][1] = new Box("rosso", 0);
        boxSchemeTest[1][2] = new Box("blu", 0);
        boxSchemeTest[1][3] = new Box("verde", 0);
        boxSchemeTest[2][2] = new Box("rosso", 0);
